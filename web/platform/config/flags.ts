...
export const FLAGS = {
  ...
  /** MP-2: AI weekly planner tab on /app/plan (server: ENABLE_MEAL_PLAN_UI) */
  mealPlanAi:
    process.env.NEXT_PUBLIC_MEAL_PLAN_ENABLED === "1" &&
    process.env.NEXT_PUBLIC_MEAL_PLAN_AI_ENABLED !== "0",
