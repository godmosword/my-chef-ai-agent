...
async def health_check():
    return {"status": "ok", "message": "米其林職人大腦 (OpenRouter Claude Sonnet 4.6 版)"}
...
def handle_message(event):
    ...
    if user_message.strip() in ["清除記憶", "重新開始", "洗腦", "你好", "嗨"]:
        ...
        reply = TextMessage(text="👨‍🍳 歡迎！廚房已打掃乾淨，頂級 Claude Sonnet 4.6 大腦已就緒。請問今天想點什麼？")
