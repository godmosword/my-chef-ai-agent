...
| 2026-05-24 | **Frontend Wave 4a**：暗色 token、Today 結果主圖 polling、`RecipeDetailLayout`；規格 [`2026-05-24-frontend-wave4-design.md`](docs/superpowers/specs/2026-05-24-frontend-wave4-design.md)。 |
